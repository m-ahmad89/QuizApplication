...
public class Quiz extends JFrame implements ActionListener {
   ...
   Quiz(String name) {
    ...
    protected void paintComponent(Graphics g) {
      ...
      this.qno = new JLabel();
      this.qno.setBounds(100, 400, 50, 25);
      this.qno.setFont(new Font("Tahoma", 0, 24));
      this.add(this.qno);

      this.question = new JLabel();
      this.question.setBounds(150, 400, 900, 25);
      ...
      this.next.setBounds(1000, 460, 170, 30);
      ...
      this.lifeline.setBounds(1000, 520, 170, 30);
      ...
      this.submit.setBounds(1000, 580, 170, 30);
